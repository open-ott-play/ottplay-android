...
The interface is currently Russian; the English listing explicitly says so. The Play distribution requires HTTPS. The HTTP-compatible Full distribution has a different package and is not a Play upload candidate. Do not upload a preview, debug APK or Full artifact under this listing.
