...
object DrmPolicy {
    ...
    fun licenseUrl(value: String): String {
        require(value.length in 1..16_384 && value == value.trim()) { "Некорректный адрес лицензии DRM" }
